...
var SETTINGS_DARK_MODE_DEFAULT = true;
var SETTINGS_SHOW_HINT_DEFAULT = true;
var STORAGE_NOTIFICATION_MESSAGE_DEFAULT =
  "You have spent a lot of time on this site";
...
function convertTimeToSummaryTime(time) {
  ...
  if (hour > 0) resultTimeValue = hour * 3600;
...
function convertSummaryTimeToString(summaryTime) {
  ...
  if (days > 0) return days + "d " + hours + "h " + mins + "m " + seconds + "s";
