...
class UI {
  ...
  setUIForToday() {
    ...
    document.getElementById("statsBlock").classList.remove("hide");
    document.getElementById("restrictionsBlock").classList.add("hide");
  ...
  setUIForSettings() {
    ...
    document.getElementById("restrictionsBlock").classList.add("hide");
    document.getElementById("statsBlock").classList.add("hide");
  }
  setUIForByDays() {
    document.getElementById("btnByDays").classList.add("active");
    document.getElementById("btnToday").classList.remove("active");
    document.getElementById("settings").classList.remove("active");
    document.getElementById("restrictionsBlock").classList.remove("hide");
    document.getElementById("statsBlock").classList.add("hide");
    document.getElementById("settingsBlock").classList.add("hide");
  }
  clearUI() {
